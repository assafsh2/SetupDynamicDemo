...
if __name__ == "__main__":
    ...
    if user_settings.run:
        ...
        if kube_settings is not None:
            ...
            kube = subprocess.Popen(["kubectl", "create", "-f -"], stdout=subprocess.PIPE, stdin=subprocess.PIPE, stderr=subprocess.STDOUT)
            print (kube.communicate(input=str(kube_settings_json))[0])
